...
> - PS：原教程是**云端部署 & 40系显卡**，本笔记是**本地部署（WSL系统） & 50系显卡（5060Ti 16GB）方案**                                                                                     ——郑群 上海大学
...
```bash
conda activate phmr
MY_PHMR_PATH="/home/qunz/every-embodied/07-机器人操作、运动控制/Locomotion/video2robot/third_party/PromptHMR"
cd $MY_PHMR_PATH
```
...
cd /home/qunz/every-embodied/07-机器人操作、运动控制/Locomotion/video2robot/third_party/PromptHMR/pipeline/detector
...
#### KeyNotes1_环境变量配置 (系统级 vs conda虚拟环境级)
...
```bash
conda activate phmr
PROJ_PATH="/home/qunz/every-embodied/07-机器人操作、运动控制/Locomotion/video2robot"
